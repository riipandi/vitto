...
# yarn
yarn create vitto@latest my-website --preset tailwindcss

# pnpm
pnpm create vitto@latest my-website --preset tailwindcss

# Bun
bun create vitto@latest my-website --preset tailwindcss
